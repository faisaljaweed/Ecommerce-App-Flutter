...
class BikneScreen extends StatefulWidget {
  const BikneScreen({super.key});

  @override
  State<BikneScreen> createState() => _BikneScreenState();
}

class _BikneScreenState extends State<BikneScreen> {
  String searchQuery = '';
